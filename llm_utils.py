...
Does the question ask for an email address, a phone number, a specific date, or an income/dollar amount?

Respond with a single word from this list: ['email', 'phone', 'date', 'income', 'general'].
...
Classification:
    ...
    try:
        ...
        for key in ['email', 'phone', 'date', 'income']:
